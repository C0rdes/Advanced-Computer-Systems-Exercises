...
public class BankAccountTest {
	...
	@Test
	public void testDepositPositive() throws AccountException {
		client.deposit(5);
		int balance = client.getBalance();
		assertTrue(balance == 5);
	}
	
	@Test(expected=IllegalArgumentException.class)
	public void testDepositNegative() throws AccountException {
		client.deposit(-5);
		fail("client.deposit does not throw exception on negative parameter");
	}
